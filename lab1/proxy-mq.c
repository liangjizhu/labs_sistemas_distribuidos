 ...
 */
 ...
 // Función auxiliar que envía una petición al servidor y espera una respuesta.
 static int send_request(struct Request *req) {
     ...
     // Esperar la respuesta (se espera un entero).
     int result;
     if (mq_receive(mq_resp, (char *)&result, sizeof(int), NULL) == -1) {
 ...
 int get_value(int key, char *value1, int *N_value2, double *V_value2, struct Coord *value3) {
     ...
     // En una implementación completa, se enviarían también los datos asociados.
     return result;
 }
